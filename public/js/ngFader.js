    ...
    angular.module('ngFader', [])
	  ...
	  return {
	    ...
	    template: '<div class="ng-fader">'+
			...
			'<ul>' + 
				'<li class="prova" ng-repeat="image in images" ng-click="toggleStartStop()" ng-swipe-right="sliderBack()" ng-swipe-left="sliderForward()"><img data-ng-src="{{image.src}}" data-ng-alt="{{image.alt}}" ng-class="show($index)"/></li>' + 
			'</ul>' + 
